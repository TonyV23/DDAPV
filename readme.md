...
- ###### gestion des utilisateurs du site :
    * Le système a deux groupes :
        ...
        -- le groupe "employees" qui contient les utilisateurs qui ont les droits de CRUD seulement 
            sur les tables de distribution et personnes .
    ...
    * Le système de gestion des mots de passe :
        En cas d'oublie du mot de passe l'utilisateur a droit de réinitialiser en mot de passe en faisant une demande d'un lien vers de réinitialisation     
